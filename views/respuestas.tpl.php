        ...
        echo"<div class=\"container theme-showcase\" role=\"main\">";
            ...
            if($_REQUEST['res'.$i.'']=='nulo'){
                echo "
                                      ...
                                      <div class=\"alert alert-warning\" role=\"alert\">Por favor. Conteste todas las preguntas</div>
...
if ($row2 = mysql_fetch_row($consulta5)) {
        ...
        if($calificacion==10){
            echo" <div class=\"alert alert-success\" role=\"alert\">Bien hecho $nombre, tu calificación es: $calificacion</div>
        ...
        {
        echo"<div class=\"alert alert-info\" role=\"alert\">$nombre, tu calificación es: $calificacion</div>
		 <meta http-equiv=\"refresh\" content=\"3;url=cuestionario.net\" />";
